...
* AES - CBC
*******************/
int aes_encrypt_cbc(const BYTE in[], size_t in_len, BYTE out[], const unsigned int key[], int keysize, const BYTE iv[])
{
...
int aes_encrypt_cbc_mac(const BYTE in[], size_t in_len, BYTE out[], const unsigned int key[], int keysize, const BYTE iv[])
{
	BYTE buf_in[AES_BLOCK_SIZE], buf_out[AES_BLOCK_SIZE], iv_buf[AES_BLOCK_SIZE];
	int blocks, idx;
...
int aes_decrypt_cbc(const BYTE in[], size_t in_len, BYTE out[], const unsigned int key[], int keysize, const BYTE iv[])
{
	BYTE buf_in[AES_BLOCK_SIZE], buf_out[AES_BLOCK_SIZE], iv_buf[AES_BLOCK_SIZE];
	int blocks, idx;
...
void aes_encrypt_ctr(const BYTE in[], size_t in_len, BYTE out[], const unsigned int key[], int keysize, const BYTE iv[])
{
...
void aes_decrypt_ctr(const BYTE in[], size_t in_len, BYTE out[], const unsigned int key[], int keysize, const BYTE iv[])
{
...
int aes_encrypt_ccm(const BYTE payload[], unsigned int payload_len, const BYTE assoc[], unsigned short assoc_len,
                    const BYTE nonce[], unsigned short nonce_len, BYTE out[], unsigned int *out_len,
                    unsigned int mac_len, const BYTE key_str[], int keysize)
{
...
int aes_decrypt_ccm(const BYTE ciphertext[], unsigned int ciphertext_len, const BYTE assoc[], unsigned short assoc_len,
                    const BYTE nonce[], unsigned short nonce_len, BYTE plaintext[], unsigned int *plaintext_len,
                    unsigned int mac_len, int *mac_auth, const BYTE key_str[], int keysize)
{
...
void aes_key_setup(const BYTE key[], unsigned int w[], int keysize)
{
	int Nb=4,Nr,Nk,idx;
...
void AddRoundKey(BYTE state[][4], const unsigned int w[])
{
	BYTE subkey[4];
...
void aes_encrypt(const BYTE in[], BYTE out[], const unsigned int key[], int keysize)
{
	BYTE state[4][4];
...
void aes_decrypt(const BYTE in[], BYTE out[], const unsigned int key[], int keysize)
{
	BYTE state[4][4];
