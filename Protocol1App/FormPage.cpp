...
void FormPage::makeConnections() {
	...
	//connect(this->line_zip, &QLineEdit::textEdited, this, &FormPage::updateContinueBtn);
}
	...
	: QWidget(parent)
{
	...
	header->setText("Thank you for your participation in this study. You are now finished answering questions. If you would like to receive compensation for your participation, please enter your name and UNI below so that we can email you a $15 prepaid debit card.");
